...
// Search select indian movies
function indmovieSelect()
{
    let selection = document.getElementById('movieSelect');
    let selectedMovie = selection.options[selection.selectedIndex].text;

    url = baseUrl+"indian_movie/"+selectedMovie;
    window.location.href = url;
}

// Search select web series
function webSeriesSelect()
{
    let selection = document.getElementById('movieSelect');
    let selectedMovie = selection.options[selection.selectedIndex].text;

    url = baseUrl+"web_series/"+selectedMovie;
    window.location.href = url;
}
